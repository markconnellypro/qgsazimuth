...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_distanceUnits.setItemText(3, _translate("Form", "Inches"))
        self.comboBox_distanceUnits.setItemText(4, _translate("Form", "Kilometers"))
        self.comboBox_distanceUnits.setItemText(5, _translate("Form", "Meters"))
        self.comboBox_distanceUnits.setItemText(6, _translate("Form", "Miles"))
        self.comboBox_distanceUnits.setItemText(7, _translate("Form", "Millimeters"))
        self.comboBox_distanceUnits.setItemText(8, _translate("Form", "Nautical Miles"))
        self.comboBox_distanceUnits.setItemText(9, _translate("Form", "Yards"))
